      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-[#1E3A8A] text-white p-8 text-center">
            ...
            <p className="text-blue-200 text-sm">Book Borrowing & Tracking System</p>
          </div>
          ...
          <div className="bg-gray-50 px-8 py-4 text-center text-sm">
            <p className="text-gray-600 mb-2">For librarians and authorized personnel only</p>
            <Link to="/student-login" className="text-[#3B82F6] hover:underline">
              Student/Borrower Portal →
            </Link>
          </div>
        </div>
      </div>
